import type { JiraEpic, InitiativeStatus } from '../types/index.js';
...
function getJiraConfig() {
  ...
  if (!host || !email || !token) {
    throw new Error('Jira is not configured. Set JIRA_HOST, JIRA_EMAIL, and JIRA_API_TOKEN environment variables.');
  }
